...
; 0000 0035 DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (1<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(15)
	OUT  0x1A,R30
...
; 0000 007B // INT1: On
; 0000 007C // INT1 Mode: Rising Edge
; 0000 007D // INT2: Off
; 0000 007E GICR|=(1<<INT1) | (1<<INT0) | (0<<INT2);
	IN   R30,0x3B
	ORI  R30,LOW(0xC0)
	OUT  0x3B,R30
; 0000 007F MCUCR=(1<<ISC11) | (1<<ISC10) | (1<<ISC01) | (1<<ISC00);
	LDI  R30,LOW(15)
	OUT  0x35,R30
; 0000 0080 MCUCSR=(0<<ISC2);
	LDI  R30,LOW(0)
	OUT  0x34,R30
; 0000 0081 GIFR=(1<<INTF1) | (1<<INTF0) | (0<<INTF2);
	LDI  R30,LOW(192)
	OUT  0x3A,R30
; 0000 0082 
...
_0xE:
; 0000 00A6         {
; 0000 00A7             uint8_t temp = PINB;
; 0000 00A8             flag_enbl = 1;
	SBIW R28,1
;	temp -> Y+0
	IN   R30,0x16
	ST   Y,R30
...
; 0000 00A9             temp &= 0x07;
	...
	ANDI R30,LOW(0x7)
	ST   Y,R30
; 0000 00AA             switch(temp)
	LDI  R31,0
; 0000 00AB             {
; 0000 00AC                 case 1: floor = 1; break;
	CPI  R30,LOW(0x1)
	LDI  R26,HIGH(0x1)
	CPC  R31,R26
	BRNE _0x12
	...
	MOVW R4,R30
	RJMP _0x11
; 0000 00AD                 case 2: floor = 2; break;
_0x12:
	CPI  R30,LOW(0x2)
	LDI  R26,HIGH(0x2)
	CPC  R31,R26
	...
	MOVW R4,R30
	RJMP _0x11
; 0000 00AE                 case 4: floor = 3; break;
_0x13:
	CPI  R30,LOW(0x4)
	LDI  R26,HIGH(0x4)
	CPC  R31,R26
